...
main (int argc, char **argv)
{
	...
	pmap_unset (COUNT_DAYS, COUNT_DAYS_VERSION);
	...
	if (!svc_register(transp, COUNT_DAYS, COUNT_DAYS_VERSION, count_days_1, IPPROTO_UDP)) {
		fprintf (stderr, "%s", "unable to register (COUNT_DAYS, COUNT_DAYS_VERSION, udp).");
		exit(1);
	}
	...
	if (!svc_register(transp, COUNT_DAYS, COUNT_DAYS_VERSION, count_days_1, IPPROTO_TCP)) {
		fprintf (stderr, "%s", "unable to register (COUNT_DAYS, COUNT_DAYS_VERSION, tcp).");
		exit(1);
	}
