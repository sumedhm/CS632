...
static void
tell_me_day1_1(struct svc_req *rqstp, register SVCXPRT *transp)
{
	union {
	...
	case no_leap_years:
		...
		_xdr_result = (xdrproc_t) xdr_dates;
...
static void
tell_me_day2_2(struct svc_req *rqstp, register SVCXPRT *transp)
{
	union {
	...
	case no_of_days:
		_xdr_argument = (xdrproc_t) xdr_dates;
		_xdr_result = (xdrproc_t) xdr_dates;
		local = (char *(*)(char *, struct svc_req *)) no_of_days_2_svc;
		break;
...
static void
tell_me_day3_3(struct svc_req *rqstp, register SVCXPRT *transp)
{
	union {
		dates get_day_3_arg;
	} argument;
	...
	case get_day:
		...
		local = (char *(*)(char *, struct svc_req *)) get_day_3_svc;
		break;
...
static void
tell_me_day4_4(struct svc_req *rqstp, register SVCXPRT *transp)
{
	union {
	...
	case get_no_of_weekday:
		_xdr_argument = (xdrproc_t) xdr_dates;
		_xdr_result = (xdrproc_t) xdr_dates;
		local = (char *(*)(char *, struct svc_req *)) get_no_of_weekday_4_svc;
		break;
