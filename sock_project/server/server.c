...
init_servers()
{
	...
	strcpy(servers[0],"172.20.205.74"); //Server 1
	strcpy(servers[1],"10.42.0.36");	//Server 2, will be used later
	//strcpy(servers[2],"172.27.30.50");
...
sync_servers(void *arg){
	...
	if(LEADER){
		...
		sleep(10); //Wait for other servers to download synclogs
